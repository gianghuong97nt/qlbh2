        ...
        <div class="form-three widget-shadow">
            ...
            <form name="product" action="{{url('admin/product')}}" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="supplier" value="{{old('supplier')}}" class="form-control1" id="focusedinput" placeholder="Nhập nhà cung cấp">
                    </div>
                </div>
                <div class="form-group">
                    <label for="focusedinput" class="col-sm-2 control-label">Images</label>
                    <div class="col-sm-8">
                        <input type="text" name="images" value="{{old('image')}}" class="form-control1" id="focusedinput" placeholder="Ảnh">
                    </div>
                </div>
                <div class="form-group">
                    <label for="intro" class="col-sm-2 control-label">Quantity</label>
                    <div class="col-sm-8">
                        <input type="text" name="quantity" value="{{old('quantity')}}" class="form-control1" id="focusedinput" placeholder="Nhập số lượng">
                    </div>
                </div>
                <div class="form-group">
                    <label for="intro" class="col-sm-2 control-label">Color</label>
                    <div class="col-sm-8">
                        <input type="text" name="color" value="{{old('color')}}" class="form-control1" id="focusedinput" placeholder="Nhập màu sắc">
                    </div>
                </div>
                <div class="form-group">
                    <label for="intro" class="col-sm-2 control-label">Size</label>
                    <div class="col-sm-8">
                        <input type="text" name="size" value="{{old('size')}}" class="form-control1" id="focusedinput" placeholder="Nhập kích cỡ">
                    </div>
                </div>
                <div class="form-group">
