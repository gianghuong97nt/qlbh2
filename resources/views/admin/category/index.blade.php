...
@section('content')
    <div class="forms tables">
        <div class="row">
            <div class="d-inline">
                <h2 class="title1">{{ trans('admin.titleCategory')}}</h2>
            </div>
                ...
                <div class="form-body">
                    <div class="row">
                        <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
                            <label class="form-control label-info">{{ trans('admin.category')}}</label>
                        </div>
            ...
            <div id="table-result">
                <div id="">
                    <table class="table table-bordered tbl_category">
                        <thead>
                        <tr class="category">
                            <th class="tbl_id">{{ trans('admin.categoryID')}} </th>
                            <th class="tbl_name">{{ trans('admin.categoryName')}} </th>
                            <th class="tbl_image">{{ trans('admin.categoryImage')}}</th>
                            <th class="tbl_desc">{{ trans('admin.categoryDesc')}}</th>
                            <th class="tbl_intro">{{ trans('admin.categoryIntro')}}</th>
