                ...
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <input type="text"  class="form-control" id="customer_name" maxlength="40"/>
                        </div>
                        <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
                            <label class="form-control label-info">{{ trans('admin.order.phonenumber') }}</label>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control" id="customer_phone" maxlength="20"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <input type="email"  class="form-control" id="customer_email" maxlength="20"/>
                        </div>
                        <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
                            <label class="form-control label-info">{{ trans('admin.order.address') }}</label>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control" id="customer_address" maxlength="100"/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="">
                    <table class="table table-bordered tbl_order">
                        ...
                        <tr class="order">
                            ...
                            <th colspan="2"  class="action tbl_action">{{ trans('admin.order.action') }}</th>
                        </tr>
                        </thead>
                        <tbody>
                        @if( isset($orders) )
